...
const envVarsSchema = Joi.object()
  .keys({
    ...
    VONAGE_API_KEY: Joi.string().description('Vonage API Key'),
    VONAGE_API_SECRET: Joi.string().description('Vonage API Secret')
  })
  .unknown();
...
const config = {
  ...
  vonage: {
    api: {
      key: envVars.VONAGE_API_KEY,
      secret: envVars.VONAGE_API_SECRET
    }
  }
};
